...
defmacro MAC1SPOKEEDGEALL5 {
    at 0.1 do SINGLEPIXEL on ALLSPOKES option  5 color BLUE;
    at 0.4 do OFF on ALLSPOKES;
};
...
defmacro MAC1PERIMETER {
 ...
 defmacro MAC3 {
 	at 0.1 do SOUNDPULSE on RINGLET1 speed 10 color GOLD;
	at 0.9 do OFF on RINGLET1;
	at 1.0 do SOUNDPULSE on RINGLET2 speed 10 color GOLD;
	at 1.9 do OFF on RINGLET2;
	at 2.0 do SOUNDPULSE on RINGLET3 speed 10 color GOLD;
	at 2.9 do OFF on RINGLET3;
	at 3.0 do SOUNDPULSE on RINGLET4 speed 10 color GOLD;
	at 3.9 do OFF on RINGLET4;
	at 4.0 do SOUNDPULSE on RINGLET5 speed 10 color GOLD;
	at 4.9 do OFF on RINGLET5;
	at 5.0 do SOUNDPULSE on RINGLET6 speed 10 color GOLD;
	at 5.9 do OFF on RINGLET6;
	at 6.0 do SOUNDPULSE on RINGLET7 speed 10 color GOLD;
	at 6.9 do OFF on RINGLET7;
	at 7.0 do SOUNDPULSE on RINGLET8 speed 10 color GOLD;
...
at 2.9 macro MAC1SPOKEEDGEALL5 ;
at 3.9 macro MAC1SPOKEEDGEALL5 ;
at 4.9 macro MAC1SPOKEEDGEALL5 ;
at 5.9 macro MAC1SPOKEEDGEALL5 ;
at 6.9 macro MAC1SPOKEEDGEALL5 ;
at 7.9 macro MAC1SPOKEEDGEALL5 ;
at 8.9 macro MAC1SPOKEEDGEALL5 ;
at 9.9 macro MAC1SPOKEEDGEALL5 ;
at 10.9 macro MAC1SPOKEEDGEALL5 ;
at 11.9 macro MAC1SPOKEEDGEALL5 ;
...
at 18.0 macro MAC4 ;  //PIXELMARCH - ALL SPOKES
